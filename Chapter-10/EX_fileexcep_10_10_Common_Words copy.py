...
result_space=contents.lower().count('the ')
#for line in lines.splitlines():
#    result += int(line.lower().count('the'))
print(f'The count of word "the" in {path} is {result}')
print(f'The count of word "the " in {path} is {result_space}')